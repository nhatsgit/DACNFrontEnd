    ...
    return(<>
        ...
        <tbody>
            <tr>
                ...
                <td  style={{paddingLeft:"20px"}}>
                    <button type="button" class="btn btn-success" style={{backgroundColor:"#198754",border:"none", padding:"10px",marginLeft:"5px"}}>
                        <a href="ShowProduct" style={{color:"white"}}>Hiện</a>
                    </button>
