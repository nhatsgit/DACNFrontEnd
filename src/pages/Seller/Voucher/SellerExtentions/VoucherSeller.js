                ...
                <div className="col-md-6">
                    <form>
                        ...
                        <div className="d-flex justify-content-between">
                            ...
                            <div style={{margin:"15px 0"}}><a href="/Voucher" style={{textDecoration:"underline",color:"blue"}} >
                                Back to List
                            </a></div>
                        </div>
                    </form>
        ...
        <div className="container mt-5">
            <div className="row justify-content-center">
                <div className="col-md-8" style={{textAlign:"left"}}>
                    ...
                    <div className=" mt-4">
                        <a href="/EditVoucher" style={{textDecoration:"underline",color:"blue"}}>Edit</a> |
...
export {EditVoucher,DetailsVoucher,DeleteVoucher};